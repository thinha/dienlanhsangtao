 ...
 * WC Tested up to: 4.8
 *
 * Copyright 2012-2020 Joost de Valk & Arjan Snaterse
 *
...
if ( ! defined( 'WPSEO_LOCAL_VERSION' ) ) {
	define( 'WPSEO_LOCAL_VERSION', '13.8' );
}
...
add_action(
	...
	function () {
		...
		if ( version_compare( WPSEO_VERSION, '15.4-RC0', '<' ) ) {
...
if ( ! function_exists( 'wpseo_local_seo_init' ) ) {
	...
	function wpseo_local_seo_init() {
		...
		if ( class_exists( '\Yoast\WP\SEO\Conditionals\Admin\Elementor_Edit_Conditional' ) ) {
			$elementor_conditional = new \Yoast\WP\SEO\Conditionals\Admin\Elementor_Edit_Conditional();
