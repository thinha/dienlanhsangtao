...
if ( ! class_exists( 'WPSEO_Local_Metaboxes' ) ) {
	...
	class WPSEO_Local_Metaboxes {
		...
		public function opening_hours_panel_content() {
			...
			echo '<div class="opening-hours-wrap" style="display:' . ( ( $open_247 === 'on' ) ? 'none' : 'block' ) . '">';
			...
			foreach ( $wpseo_local_core->days as $key => $day ) {
				...
				echo '<select class="openinghours_from" style="width: 100px;" id="' . $field_name . '_from" name="' . $field_name . '_from" ' . ( ( $value_24h === 'on' ) ? 'disabled="disabled"' : '' ) . '>';
				echo wpseo_show_hour_options( $use_24_hours, $value_from );
				echo '</select>';
				echo '<span> - </span>';
				echo '<select class="openinghours_to" style="width: 100px;" id="' . $field_name . '_to" name="' . $field_name . '_to" ' . ( ( $value_24h === 'on' ) ? 'disabled="disabled"' : '' ) . '>';
				...
				echo '<select class="openinghours_from_second" style="width: 100px;" id="' . $field_name . '_second_from" name="' . $field_name . '_second_from" ' . ( ( $value_24h === 'on' ) ? 'disabled="disabled"' : '' ) . '>';
				echo wpseo_show_hour_options( $use_24_hours, $value_second_from );
				echo '</select>';
				echo '<span> - </span>';
				echo '<select class="openinghours_to_second" style="width: 100px;" id="' . $field_name . '_second_to" name="' . $field_name . '_second_to" ' . ( ( $value_24h === 'on' ) ? 'disabled="disabled"' : '' ) . '>';
