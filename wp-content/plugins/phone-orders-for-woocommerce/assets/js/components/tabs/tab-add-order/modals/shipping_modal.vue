        ...
        >
            <div id="shipping_method">
				...
				{{ shippingMethod.label }}
                            ...
                            <span v-else-if="+shippingMethod.cost">:
    ...
    export default {
        created() {
            this.$root.bus.$on('edit-shipping-package', (hash) => {
                ...
                if ( !! item.chosen_rate ) {
                    ...
                    this.newShippingPrice = !! item.chosen_rate.cost ? item.chosen_rate.cost : null;
        ...
        watch: {
            elSelectedShippingMethodID(newVal) {
                if (!this.newShippingPriceApplied && newVal) {
		...
		if (customTitle.enabled) {
		    chosenRate = Object.assign({}, chosenRate, {label: customTitle.title})
                ...
                let shippingPackage = Object.assign({}, this.selectedPackage, {
                    ...
                    custom_price: this.prepareCartShippingCustomPrice(),
