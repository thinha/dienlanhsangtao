		...
		<slot name="edit-customer-address-modal-header"></slot>
			...
			></custom-autocomplete>
                        ...
                        <b-row v-for="row in group.rows">
                            ...
                            <b-col v-for="(loopField, numIndex) in row" :md="countCols" cols="12">
...
<script>
	...
	export default {
		props: {
                    ...
                    personalFieldsOrder: {
                        default: function() {
                            return ['email', 'role', 'first_name', 'last_name', 'company', 'phone'];
                        }
                    },
                    addressFieldsOrder: {
                        default: function() {
		...
		methods: {
			...
			onEnter: function ( fieldKey ) {
				...
				if (skipFields.indexOf(fieldKey) === -1) {
				    ...
				    var value = this.customer['billing_' + fieldKey];
