...
and this leads to two lightboxes shown after clicking on an image attached to a review.', IVOLE_TEXT_DOMAIN ),
            ...
            array(
                ...
                'desc'    => __( 'Enable shortcodes and Gutenberg blocks', IVOLE_TEXT_DOMAIN ) . '<br><br>' .
                    ...
                    'This shortcode supports arguments: <b>[cusrev_all_reviews sort="DESC" sort_by="date" per_page="10" number="-1" show_summary_bar="true" show_pictures="false" ' .
                    ...
                    '<ul><li><b>"sort"</b> argument defines how reviews are sorted. Possible values are "ASC" and "DESC".</li><li><b>"sort_by"</b> argument ' .
                    'accepts "date" to sort reviews by date and "helpful" to sort reviews by upvotes.</li><li><b>"per_page"</b> argument ' .
                    ...
                    'products="" color_ex_brdr="#ebebeb" color_brdr="#ebebeb" color_ex_bcrd="" color_bcrd="#fbfbfb" color_pr_bcrd="#f2f2f2" color_stars="#6bba70" shop_reviews="false" count_shop_reviews="1" inactive_products="false" avatars="true" show_more="0"]</b>.' .
            ...
            array(
                'title' => __( 'Lazy Load Reviews', IVOLE_TEXT_DOMAIN ),
                'type'  => 'title',
                'desc'  => __( 'Settings to display reviews with \'Show more\' button instead of the standard WordPress pagination.', IVOLE_TEXT_DOMAIN ),
                'id'    => 'ivole_options_ajax'
            ),
            array(
                'title'   => __( 'Lazy Load Reviews', IVOLE_TEXT_DOMAIN ),
                'desc'    => __( 'Display reviews on product pages with \'Show more\' button.', IVOLE_TEXT_DOMAIN ),
                'id'      => 'ivole_ajax_reviews',
                'default' => 'no',
                'type'    => 'checkbox'
            ),
            array(
                'title'    => __( 'Default Quantity of Reviews', IVOLE_TEXT_DOMAIN ),
                'desc'     => __( 'Specify the default number of reviews that will be shown during the initial product page load.', IVOLE_TEXT_DOMAIN ),
            ...
            array(
                'title'    => __( 'Default Sorting Order', IVOLE_TEXT_DOMAIN ),
                'type'     => 'select',
                'desc'     => __( 'Define how reviews are sorted by default. The option to vote for reviews must be enabled to show the most helpful reviews first.', IVOLE_TEXT_DOMAIN ),
                'default'  => 'recent',
                'id'       => 'ivole_ajax_reviews_sort',
                'desc_tip' => true,
                'class'    => 'wc-enhanced-select',
                'options'  => array(
                    'recent'  => __( 'Recent reviews first', IVOLE_TEXT_DOMAIN ),
                    'helpful' => __( 'Most helpful reviews first', IVOLE_TEXT_DOMAIN )
                )
            ),
            array(
                'title'   => __( 'Review Form', IVOLE_TEXT_DOMAIN ),
                'desc'    => __( 'Display a review form on product pages. If you would like to protect your site from SPAM reviews and allow customers to submit reviews only via invitations (review reminders), this option should be disabled.', IVOLE_TEXT_DOMAIN ),
