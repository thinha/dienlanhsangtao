...
require_once('class-cr-ajax-reviews.php');
...
require_once('class-cr-admin-menu-tags.php');
...
require_once('class-cr-export-reviews.php');
require_once('class-cr-reviews-exporter.php');
require_once('class-cr-tags.php');
