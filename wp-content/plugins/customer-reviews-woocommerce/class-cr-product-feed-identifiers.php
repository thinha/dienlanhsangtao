    ...
    protected function init_settings() {
      $this->settings = array(
        ...
        array(
  				...
  				'desc'     => __( 'Add GTIN field to WooCommerce products. GTIN refers to a Global Trade Item Number, a globally unique number used to identify trade items, products, or services that can be purchased. GTIN is also an umbrella term that refers to UPC, EAN, JAN, and ISBN.', 'customer-reviews-woocommerce' ),
  				'default'  => 'no',
  				'type'     => 'checkbox'
  			),
        array(
  				...
  				'desc'     => __( 'Add MPN field to WooCommerce products. MPN refers to a Manufacturer Part Number, a number that uniquely identifies the product to its manufacturer.', 'customer-reviews-woocommerce' ),
  				'default'  => 'no',
  				'type'     => 'checkbox'
  			),
        array(
  				...
  				'desc'     => __( 'Add Brand field to WooCommerce products. This field refers to a brand of the product.', 'customer-reviews-woocommerce' ),
  				'default'  => 'no',
  				'type'     => 'checkbox'
  			),
        array(
  				...
  				'desc'     => __( 'Add identifier_exists field to WooCommerce products. Use it to indicate whether or not the unique product identifiers and brand are available for a product.', 'customer-reviews-woocommerce' ),
  				'default'  => 'no',
  				'type'     => 'checkbox'
  			),
        array(
        ...
        <td colspan="2" style="padding-left:0px;padding-right:0px;">
          <table class="cr-product-feed-categories widefat">
            <thead>
                  ...
                  echo Ivole_Admin::ivole_wc_help_tip( __( 'Product identifiers required by Google Shopping', 'customer-reviews-woocommerce' ) );
                  ?>
                </th>
          		</tr>
          	</thead>
