...
class Ivole_Review_Reminder_Settings {
    ...
    protected function init_settings() {
        $language_desc = sprintf( __( 'Choose language that will be used for different elements of emails and review forms. If your language is not in the list, submit a translation by filling out %1$sthis form%2$s. Your translation will added with the next update of the plugin.', 'customer-reviews-woocommerce' ), '<a href="https://goo.gl/forms/8D4poyIBRq2MtWEP2" target="_blank">', '</a>' );
