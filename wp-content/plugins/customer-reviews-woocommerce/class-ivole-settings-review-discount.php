    ...
    protected function init_settings() {
        $this->settings = array(
            array(
                ...
                'type'  => 'title',
                'desc'  => __( 'Customize CusRev settings for sending discount coupons to customers who left reviews. By enabling and using this feature, you agree to <a href="https://www.cusrev.com/terms.html" target="_blank">terms and conditions</a>.', IVOLE_TEXT_DOMAIN ),
            ...
            array(
                'title'    => __( 'Coupon prefix', IVOLE_TEXT_DOMAIN ),
                'type'     => 'text',
                'desc'     => __( 'A prefix that will be added to coupon codes generated by the plugin.', IVOLE_TEXT_DOMAIN ),
            ...
            if ( get_post_type( $coupon_id ) == 'shop_coupon' && get_post_status( $coupon_id ) == 'publish' ) {
                ...
                if ( $discount_type == 'percent' ) {
                    ...
                    $discount_string = trim(
                        strip_tags(
                            CR_Email_Func::cr_price( $discount_amount, array( 'currency' => get_option( 'woocommerce_currency' ) ) )
                        )
                    );
                }
            } else {
