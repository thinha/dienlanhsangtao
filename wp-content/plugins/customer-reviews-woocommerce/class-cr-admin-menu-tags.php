...
class CR_Tags_Admin_Menu {
    ...
    public function include_css_js( $hook ) {
        if( $hook === "comment.php" ) {
            ...
            wp_enqueue_script( 'cr-admin-tags', plugins_url('js/admin-tags.js', __FILE__ ) );
        }
    }
    ...
    public function init_list_table( $current_screen ) {
        $args = array(
          'screen' => $current_screen
        );
        $this->tags_table = new CR_Tags_List_Table( $args );
    }
