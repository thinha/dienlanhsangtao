<div class="row category-page-row">
		...
		<div class="col large-9">
		    <div class="cat-products_title-sort">
				<div class="cat-products_title">
					<?php do_action('flatsome_products_location_tile'); ?>
				</div>
				<div class="cat-product_sort">
					<?php do_action('flatsome_products_location_sort'); ?>
				</div>
			</div>
		<?php
		/**
