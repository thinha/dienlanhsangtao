...
add_action( 'flatsome_products_location_sort', 'wc_setup_loop' );
// add_action( 'flatsome_products_location_sort', 'woocommerce_result_count', 20 );
add_action( 'flatsome_products_location_sort', 'woocommerce_catalog_ordering', 30);
...
// add_action( 'flatsome_products_location_tile', 'flatsome_add_category_filter_button', 20 );
...
add_action( 'flatsome_products_location_tile', 'flatsome_category_title', 1 );
...
add_action( 'flatsome_products_location_tile', 'flatsome_shop_loop_tools_breadcrumbs', 10 );
