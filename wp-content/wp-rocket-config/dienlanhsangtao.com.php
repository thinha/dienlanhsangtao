...
$rocket_cookie_hash = '8665a81a60cf4c74485afbb8c72bd542';
$rocket_logged_in_cookie = 'wordpress_logged_in_8665a81a60cf4c74485afbb8c72bd542';
$rocket_cache_mobile_files_tablet = 'desktop';
$rocket_cache_mobile = 1;
$rocket_do_caching_mobile_files = 1;
$rocket_cache_webp = 1;
$rocket_cache_reject_uri = '/(.+/)?feed/?|/(?:.+/)?embed/|/thanh-toan/(.*)|/gio-hang/|/my-account/(.*)|/wc-api/v(.*)|/(index\.php/)?wp\-json(/.*|$)';
...
$rocket_secret_cache_key = '5fd2352541404186182756';
$rocket_cache_ssl = 1;
